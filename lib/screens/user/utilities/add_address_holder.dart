...
class AddAddressHolder extends StatefulWidget {
  const AddAddressHolder({super.key});

  @override
  State<AddAddressHolder> createState() => _AddAddressHolderState();
}

class _AddAddressHolderState extends State<AddAddressHolder> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                20.ht,
                primaryText(
                  text: "Kindly Fill in the Correct the Address details",
                  color: Colors.red,
                ),
                20.ht,
                AuthTextFiled(
                    ...
                    Container(
                      ...
                      child: DropdownButton<String>(
                        ...
                        onChanged: (value) {
                          setState(() {
                            userPicked = value!;
                            _addAddressHolderController.printUserPicked(value);
                            _addAddressHolderController.countryPicked = value;
                            statesPicked = null;
                            loadStates();
                          });
                        },
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: DropdownButton<String>(
                        ...
                        onChanged: (value) {
                          setState(() {
                            _addAddressHolderController.statePicked = value;
                            statesPicked = value!;
                          });
                        },
                      ),
                ...
                AppButton(
                  ...
                  function: _addAddressHolderController.submitAddress,
                ),
              ],
            ),
          ),
